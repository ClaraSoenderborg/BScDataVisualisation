...
build/repoGitLog: 
	...
	GOARCH=arm64 GOOS=linux go build -ldflags="-X main.version=${REPOGITLOG_VERSION}" -o build/linux-arm64/repoGitLog ./repoGitLog/.
	GOARCH=arm64 GOOS=darwin go build -ldflags="-X main.version=${REPOGITLOG_VERSION}" -o build/darwin-arm64/repoGitLog ./repoGitLog/.
	GOARCH=amd64 GOOS=darwin go build -ldflags="-X main.version=${REPOGITLOG_VERSION}" -o build/darwin-amd64/repoGitLog ./repoGitLog/.
...
build/repoFilter: 
	...
	GOARCH=arm64 GOOS=linux go build -ldflags="-X main.version=${REPOFILTER_VERSION}" -o build/linux-arm64/repoFilter ./repoFilter/.
	GOARCH=arm64 GOOS=darwin go build -ldflags="-X main.version=${REPOFILTER_VERSION}" -o build/darwin-arm64/repoFilter ./repoFilter/.
	GOARCH=amd64 GOOS=darwin go build -ldflags="-X main.version=${REPOFILTER_VERSION}" -o build/darwin-amd64/repoFilter ./repoFilter/.
...
build/repoPie: 
	...
	GOARCH=arm64 GOOS=linux go build -ldflags="-X main.version=${REPOPIE_VERSION}" -o build/linux-arm64/repoPie ./repoPie/.
	GOARCH=arm64 GOOS=darwin go build -ldflags="-X main.version=${REPOPIE_VERSION}" -o build/darwin-arm64/repoPie ./repoPie/.
	GOARCH=amd64 GOOS=darwin go build -ldflags="-X main.version=${REPOPIE_VERSION}" -o build/darwin-amd64/repoPie ./repoPie/.
